      ...
      <section className="border-b border-slate-200 bg-[#f6f8fb]">
        <div className="mx-auto grid max-w-[1160px] min-w-0 gap-5 px-4 py-5 sm:gap-8 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start lg:gap-x-12 lg:py-12">
          <div className="min-w-0 lg:col-start-1 lg:row-start-1">
            <p className="mb-3 flex items-center gap-2 text-xs font-extrabold uppercase leading-5 text-[#187b36]">
          ...
          <div className="min-w-0 lg:col-start-1 lg:row-start-2">
            ...
            <a href="tel:16198307005" className="mt-5 inline-flex min-h-11 items-center gap-2 font-extrabold text-[#146c30] underline decoration-[#146c30]/30 underline-offset-4">
